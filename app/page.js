    ...
    <>
      ...
      <main className="layout">
        ...
        <aside className="side-stack">
          ...
          <section className="panel" aria-labelledby="adminTitle">
            <div className="section-heading">
              <div>
  ...
  return (
    <article className="match-card">
      ...
      <div className="score-row">
        ...
        <button className="save-pick" type="button" onClick={handleSave}>
          Guardar
        </button>
      </div>
      <div className="result-line">
        {result ? `Resultado: ${result.home}-${result.away} | Tus puntos: ${scorePrediction(pick, result)}` : "Resultado pendiente"}
      </div>
    </article>
  );
}
